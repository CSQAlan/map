...
class RoadSegment(TimestampMixin, Base):
    ...
    surface_type: Mapped[str] = mapped_column(String(30), default="CONCRETE", nullable=False)
    width_m: Mapped[float] = mapped_column(Numeric(5, 2), default=1.50, nullable=False)
    ...
    has_handrail: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    has_ramp: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    shade_coverage_percent: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    bench_count: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
